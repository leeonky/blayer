...
extern int ffmpeg_reload_resampler(ffmpeg_resampler *, const audio_frames *, int, uint64_t, enum AVSampleFormat, audio_frames *, void *, int(*)(ffmpeg_resampler *, void *, io_stream *), io_stream *);
