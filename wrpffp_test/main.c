...
/*SUITE_CASE("should raise error when stream not exist, and make sure close file") {*/
	/*stream_index = 1;*/

	/*CUE_ASSERT_SUBJECT_FAILED_WITH(-1);*/

	/*CUE_ASSERT_STDERR_EQ("Error[wrpffp]: stream(1) dosen't exist\n");*/
...
SUITE_END(wrpffp_test);

int main() {
	init_test();

	ADD_SUITE(wrpffp_test);
